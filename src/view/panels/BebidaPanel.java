...
public class BebidaPanel extends JPanel {
	...
	public BebidaPanel() {
		...
		gbl_panel.columnWidths = new int[]{379, 233, 0};
		...
		gbl_panel_1.columnWidths = new int[]{11, 102, 36, 91, 0};
		gbl_panel_1.rowHeights = new int[]{0, 0, 143, 229, 0};
		...
		JLabel lblNewLabel_3 = new JLabel("Quantidade(ml):");
		...
		gbc_panel_2.insets = new Insets(0, 0, 6, 5);
