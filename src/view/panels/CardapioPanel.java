...
public class CardapioPanel extends JPanel {
	...
	public CardapioPanel(JFrame main, final Restaurante restaurante, Cardapio cardapio) {
		...
		panel_4.add(tfNome, gbc_textField);
	...
	public CardapioPanel(JFrame main, final Restaurante restaurante, Controller<Cardapio> cardapios) {
		...
		btnSessao = new JButton("Nova Sessão");
		btnSessao.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Cardapio car = null;
				JDialog d = new SessaoDialog(main, restaurante, car);
				d.setVisible(true);
			}
		});
		
		GridBagConstraints gbc_BtnSessao = new GridBagConstraints();
		gbc_BtnSessao.fill = GridBagConstraints.HORIZONTAL;
		gbc_BtnSessao.insets = new Insets(0, 0, 0, 5);
		gbc_BtnSessao.gridx = 1;
		gbc_BtnSessao.gridy = 0;
		panel_6.add(btnSessao, gbc_BtnSessao);
